...
public class ExtentDemoTest {
    ...
    //this will define a test , enables adding logs author , test steps
    ...
    public void setup() {
        ...
        //initialize the html reporter with the report with
        htmlReporter = new ExtentHtmlReporter(path);

        //attach the html to report object
    ...
    public void test1(){
        ...
        //pas() --> marks the test case as passed
